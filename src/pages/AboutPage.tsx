              ...
              <motion.div variants={itemVariants} className="grid md:grid-cols-3 gap-8">
                <Card className="bg-white/95 backdrop-blur-xl border-hyve-content/20">
                  <CardContent className="p-6">
                    <Award className="h-10 w-10 text-hyve-interactive mb-4" />
                    <h3 className="text-xl font-semibold text-hyve-header mb-3">
                      Academic Excellence
                    </h3>
                    <p className="text-sm text-hyve-text/80 mb-4">
                      Collaborating with leading UK universities
                    </p>
                ...
                <Card className="bg-white/95 backdrop-blur-xl border-hyve-content/20">
                  <CardContent className="p-6">
                    <Target className="h-10 w-10 text-hyve-interactive mb-4" />
                    <h3 className="text-xl font-semibold text-hyve-header mb-3">
                      Industry Leaders
                    </h3>
                    <p className="text-sm text-hyve-text/80 mb-4">
                      Working with aerospace, automotive, and energy sectors
                    </p>
                    <ul className="space-y-1 text-sm text-hyve-text/70">
                      <li>• ATI Portfolio Integration</li>
                      <li>• Major OEMs</li>
                ...
                <Card className="bg-white/95 backdrop-blur-xl border-hyve-content/20">
                  <CardContent className="p-6">
                    <Globe className="h-10 w-10 text-hyve-interactive mb-4" />
                    <h3 className="text-xl font-semibold text-hyve-header mb-3">
                      Government Programs
                    </h3>
                    <p className="text-sm text-hyve-text/80 mb-4">
                      Supporting national innovation initiatives
                    </p>
                    <ul className="space-y-1 text-sm text-hyve-text/70">
                      <li>• UK Aerospace Technology Institute</li>
                      <li>• Clean Aviation Programs</li>
