  ...
  features: [
    {
      ...
      description:
        'Captures wind flow, temperature variations, and structural stress for optimal performance.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Enhances wind turbine aerodynamics, optimizes solar panel orientation, and improves hydro system reliability.',
    },
    {
      title: 'Sustainability & Longevity',
      description:
        'Reduces maintenance costs, prevents energy losses, and extends system lifespan.',
    },
  ],
  summary:
    'By replacing static and outdated monitoring systems, Hyve Dynamics delivers real-world, real-time data to help renewable energy operators increase output, reduce downtime, and drive sustainability efforts forward.',
  cta: 'Unlock the full potential of renewable energy with Hyve Dynamics.',
}

export const EnergyPage = () => {
  return <IndustryPageFocused industry={energyData} />
}
